...
export default function Container({ className: _className, children, ...props }: PropsWithChildren<ContainerType>) {
    const className = ["mx-auto cursor-default min-h-screen w-full text-lg tracking-tighter flex justify-center items-center tracking-tighter, px-4 pt-12 pb-24", _className].join(" ");
    return (
